...
public class ConfigData {
  ...
  @Comment("/*\n" +
      ...
      " * - Use folder paths like 'mods/' to include an entire directory and its contents.\n" +
  ...
  @Comment("/*\n" +
      " * Deprecated: Use 'additional_files' instead. This option will be removed in a future version.\n" +
      " */")
